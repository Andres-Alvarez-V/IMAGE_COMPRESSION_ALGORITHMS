...
def minimum_seam(energy_map, r, c):#O(n*m)
...
def crop_c(img, energyMap, scale_c):    
    ...
    new_c = int(scale_c * c)
    for _ in trange(c - new_c):#O(l*(n*m)) # tqdm es lo mismo que un range pero sirve para mostrar una barra de carga
